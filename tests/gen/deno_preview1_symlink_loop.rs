...
fn preview1_symlink_loop() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_symlink_loop.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_symlink_loop");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_symlink_loop");
        cmd1.arg("--jco-import");
