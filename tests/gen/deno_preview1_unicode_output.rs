...
fn preview1_unicode_output() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_unicode_output.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_unicode_output");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_unicode_output");
        cmd1.arg("--jco-import");
