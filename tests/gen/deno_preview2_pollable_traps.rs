...
#[test]
fn preview2_pollable_traps() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview2_pollable_traps.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview2_pollable_traps");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview2_pollable_traps");
        cmd1.arg("--jco-import");
