...
fn preview1_overwrite_preopen() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_overwrite_preopen.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_overwrite_preopen");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_overwrite_preopen");
        cmd1.arg("--jco-import");
