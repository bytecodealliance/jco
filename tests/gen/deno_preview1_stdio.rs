...
fn preview1_stdio() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_stdio.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_stdio");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_stdio");
        cmd1.arg("--jco-import");
