...
fn preview1_stdio_not_isatty() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_stdio_not_isatty.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_stdio_not_isatty");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_stdio_not_isatty");
        cmd1.arg("--jco-import");
        cmd1.arg("./tests/virtualenvs/notty.js");
