...
fn http_outbound_request_invalid_port() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/http_outbound_request_invalid_port.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_http_outbound_request_invalid_port");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_http_outbound_request_invalid_port");
        cmd1.arg("--jco-import");
