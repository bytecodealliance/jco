...
#[test]
fn http_outbound_request_timeout() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/http_outbound_request_timeout.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_http_outbound_request_timeout");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_http_outbound_request_timeout");
        cmd1.arg("--jco-import");
