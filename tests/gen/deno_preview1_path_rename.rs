...
fn preview1_path_rename() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_path_rename.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_path_rename");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_path_rename");
        cmd1.arg("--jco-import");
