...
fn preview1_path_symlink_trailing_slashes() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_path_symlink_trailing_slashes.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_path_symlink_trailing_slashes");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_path_symlink_trailing_slashes");
        cmd1.arg("--jco-import");
