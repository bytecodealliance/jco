...
fn preview2_udp_sockopts() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview2_udp_sockopts.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview2_udp_sockopts");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview2_udp_sockopts");
        cmd1.arg("--jco-import");
