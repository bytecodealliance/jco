...
fn preview2_random() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview2_random.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview2_random");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview2_random");
        cmd1.arg("--jco-import");
