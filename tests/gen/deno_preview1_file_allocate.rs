...
fn preview1_file_allocate() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_file_allocate.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_file_allocate");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_file_allocate");
        cmd1.arg("--jco-import");
