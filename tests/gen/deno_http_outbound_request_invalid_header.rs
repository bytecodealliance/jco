...
fn http_outbound_request_invalid_header() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/http_outbound_request_invalid_header.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_http_outbound_request_invalid_header");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_http_outbound_request_invalid_header");
        cmd1.arg("--jco-import");
