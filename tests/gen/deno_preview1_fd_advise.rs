...
fn preview1_fd_advise() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_fd_advise.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_fd_advise");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_fd_advise");
        cmd1.arg("--jco-import");
