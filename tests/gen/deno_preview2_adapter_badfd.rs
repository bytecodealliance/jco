...
fn preview2_adapter_badfd() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview2_adapter_badfd.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview2_adapter_badfd");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview2_adapter_badfd");
        cmd1.arg("--jco-import");
