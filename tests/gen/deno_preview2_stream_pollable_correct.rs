...
fn preview2_stream_pollable_correct() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview2_stream_pollable_correct.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview2_stream_pollable_correct");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview2_stream_pollable_correct");
        cmd1.arg("--jco-import");
