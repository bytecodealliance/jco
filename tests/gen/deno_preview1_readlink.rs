...
fn preview1_readlink() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_readlink.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_readlink");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_readlink");
        cmd1.arg("--jco-import");
