...
fn preview1_directory_seek() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_directory_seek.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_directory_seek");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_directory_seek");
        cmd1.arg("--jco-import");
