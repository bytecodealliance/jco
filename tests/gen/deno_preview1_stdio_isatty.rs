...
fn preview1_stdio_isatty() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_stdio_isatty.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_stdio_isatty");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_stdio_isatty");
        cmd1.arg("--jco-import");
