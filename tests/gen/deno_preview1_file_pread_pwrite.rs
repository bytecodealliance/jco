...
fn preview1_file_pread_pwrite() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_file_pread_pwrite.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_file_pread_pwrite");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_file_pread_pwrite");
        cmd1.arg("--jco-import");
