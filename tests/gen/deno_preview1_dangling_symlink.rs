...
fn preview1_dangling_symlink() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_dangling_symlink.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_dangling_symlink");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_dangling_symlink");
        cmd1.arg("--jco-import");
