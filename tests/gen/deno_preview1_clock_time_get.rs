...
fn preview1_clock_time_get() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview1_clock_time_get.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_clock_time_get");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_clock_time_get");
        cmd1.arg("--jco-import");
