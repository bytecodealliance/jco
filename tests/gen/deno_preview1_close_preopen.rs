...
fn preview1_close_preopen() -> anyhow::Result<()> {
    {
        let wasi_file = "./tests/gen/preview1_close_preopen.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_preview1_close_preopen");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_preview1_close_preopen");
        cmd1.arg("--jco-import");
