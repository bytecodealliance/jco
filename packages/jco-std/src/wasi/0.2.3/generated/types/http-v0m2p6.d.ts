...
declare module 'bytecodealliance:jco-std/http-v0m2p6' {
  ...
  export type * as WasiConfigStore020Draft from 'wasi:config/store@0.2.0-draft'; // import wasi:config/store@0.2.0-draft
  export type * as WasiHttpIncomingHandler026 from 'wasi:http/incoming-handler@0.2.6'; // import wasi:http/incoming-handler@0.2.6
