 ...
 */
import {
    getEnvironment as wasiCLIEnvGetEnvironment,
    getArguments as wasiCLIEnvGetArguments,
    initialCwd as wasiCLIEnvInitialCwd,
} from "wasi:cli/environment@0.2.3";
import {
    get as wasiConfigGet,
    getAll as wasiConfigGetAll,
} from "wasi:config/store@0.2.0-rc.1";
