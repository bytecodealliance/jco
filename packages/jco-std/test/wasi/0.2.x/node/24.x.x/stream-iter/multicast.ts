...
describe("stream/iter multicast", () => {
  test.concurrent("broadcasts pushed batches to concurrent consumers", async () => {
  ...
  test.concurrent("shares pull sources between concurrent async and sync consumers", async () => {
  ...
  test.concurrent("delegates static construction through protocol symbols", () => {
