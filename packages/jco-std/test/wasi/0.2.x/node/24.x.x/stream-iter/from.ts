...
describe("stream/iter sources", () => {
  test.concurrent("normalizes strings, buffers, views, and recursively nested iterables", async () => {
  ...
  test.concurrent("prefers async and sync conversion protocols over iteration", async () => {
    const value = {
  ...
  test.concurrent("accepts promises yielded by async sources", async () => {
  ...
  test.concurrent("bounds pre-batched arrays", async () => {
  ...
  test.concurrent("rejects null, invalid, and async-only sync sources", () => {
