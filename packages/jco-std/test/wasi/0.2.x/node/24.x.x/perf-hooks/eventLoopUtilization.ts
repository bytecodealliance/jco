...
test("eventLoopUtilization explicitly denies native telemetry without touching arguments", () => {
  ...
  expect(() => Reflect.apply(shim.eventLoopUtilization, null, [poison])).toThrow(
