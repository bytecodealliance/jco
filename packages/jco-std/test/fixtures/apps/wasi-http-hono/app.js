 ...
 * of `wasi:http` interfaces is not hampered by support in StarlingMonkey -- when
 * using the interfaces manually we can use whatever version of `wasi:http` we want.
 *
