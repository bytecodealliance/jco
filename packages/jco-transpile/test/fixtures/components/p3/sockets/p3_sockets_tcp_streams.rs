...
//! checked in as both `p3-sockets-tcp-streams.wasm` files below this fixture
//! tree.
//!
...
//!
//! TODO: Upstream this correction to Wasmtime and replace this local source and
//! rebuilt fixture with the upstream artifact once it is available.
