...
suite('stream<T> lifts', () => {
    ...
    test.concurrent('string', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamString(vals);
    ...
    test.concurrent('record', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamRecord(vals);
    ...
    test.concurrent('tuple', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamTuple(vals);
    ...
    test.concurrent('flags', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamFlags(vals);
    ...
    test.concurrent('enum', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamEnum(vals);
    ...
    test.concurrent('option<string>', async () => {
        ...
        const vals = ['present string', null];
        const stream = await instance['jco:test-components/get-stream-async'].getStreamOptionString(vals);
        await checkStreamValues({
            stream,
    ...
    test.concurrent('list<u8>', async () => {
        ...
        const vals = [[0x01, 0x02, 0x03, 0x04, 0x05], new Uint8Array([0x05, 0x04, 0x03, 0x02, 0x01]), []];
        const stream = await instance['jco:test-components/get-stream-async'].getStreamListU8(vals);
    ...
    test.concurrent('list<string>', async () => {
        ...
        const vals = [['first', 'second', 'third'], []];
        const stream = await instance['jco:test-components/get-stream-async'].getStreamListString(vals);
        await checkStreamValues({
            stream,
            expectedValues: vals,
    ...
    test.concurrent('list<u32, 5>', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamFixedListU32(vals);
        await checkStreamValues({
            stream,
            expectedValues: vals,
            typeName: 'list<u32, 5>',
    ...
    test.concurrent('list<record>', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamListRecord(vals);
        await checkStreamValues({
            stream,
            expectedValues: vals,
    ...
    test.concurrent('result<string>', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamResultString(vals);
        await checkStreamValues({
            stream,
            expectedValues: vals,
    ...
    test.concurrent('example-resource', async () => {
        ...
        const vals = [2, 1, 0];
        const stream = await instance['jco:test-components/get-stream-async'].getStreamExampleResourceOwn(vals);
        const resources = [];
        const retrievedIds = [];
        ...
        for (const resource of resources) {
            ...
            const expectedID = resource.getId();
    ...
    test.concurrent('example-resource#get-id', async () => {
        ...
        const vals = [new ExampleResource(2), new ExampleResource(1), new ExampleResource(0)];
        const stream = await instance['jco:test-components/get-stream-async'].getStreamExampleResourceOwnAttr(vals);
    ...
    test.concurrent('stream<string>', async () => {
        ...
        const stream = await instance['jco:test-components/get-stream-async'].getStreamStreamString(vals);
        for (const v of vals) {
