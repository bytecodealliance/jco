...
export function print(
    binary: Parameters<import("../obj/wasm-tools.js").print>[0],
): Promise<ReturnType<import("../obj/wasm-tools.js").print>>;
/**
 * @param {Parameters<import('../obj/wasm-tools.js').parse>[0]} wat
 * @return {Promise<ReturnType<import('../obj/wasm-tools.js').parse>>}
 */
export function parse(
    wat: Parameters<import("../obj/wasm-tools.js").parse>[0],
): Promise<ReturnType<import("../obj/wasm-tools.js").parse>>;
/**
...
export function componentWit(
    binary: Parameters<import("../obj/wasm-tools.js").componentWit>[0],
): Promise<ReturnType<import("../obj/wasm-tools.js").componentWit>>;
/**
...
export function componentNew(
    binary: Parameters<import("../obj/wasm-tools.js").componentNew>[0],
    adapters: Parameters<import("../obj/wasm-tools.js").componentNew>[1],
): Promise<ReturnType<import("../obj/wasm-tools.js").componentNew>>;
/**
...
export function componentEmbed(
    embedOpts: Parameters<import("../obj/wasm-tools.js").componentEmbed>[0],
): Promise<ReturnType<import("../obj/wasm-tools.js").componentEmbed>>;
/**
 ...
 */
export function metadataAdd(
    binary: Parameters<import("../obj/wasm-tools.js").metadataAdd>[0],
    metadata: Parameters<import("../obj/wasm-tools.js").metadataAdd>[1],
): Promise<ReturnType<import("../obj/wasm-tools.js").metadataAdd>>;
/**
 ...
 */
export function metadataShow(
    binary: Parameters<import("../obj/wasm-tools.js").metadataShow>[0],
): Promise<ReturnType<import("../obj/wasm-tools.js").metadataShow>>;
