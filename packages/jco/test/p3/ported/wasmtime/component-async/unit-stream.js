...
// wasmtime/crates/misc/component-async-tests/tests/scenario/unit-stream.rs
//
suite("unit streams scenario", () => {
    test("caller & callee", async () => {
        const callerPath = join(COMPONENT_FIXTURES_DIR, "p3/streams/async-unit-stream-caller.wasm");
        const calleePath = join(COMPONENT_FIXTURES_DIR, "p3/streams/async-unit-stream-callee.wasm");
