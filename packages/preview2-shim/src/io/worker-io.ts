...
import type { streams as StreamsNamespace } from "../../types/io.js";
...
const finalizationRegistry = new FinalizationRegistry((dispose: any) => void dispose());
