...
* `src/api.ts`: The jco API which can be used as a library dependency. It is compiled to `dist/api.js` and published as [`@bytecodealliance/jco`](https://npmjs.org/package/@bytecodealliance/jco).
