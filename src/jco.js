...
program.command('transpile')
  ...
  .option('--async-imports <imports...>', 'async component imports (examples: "wasi:io/poll@0.2.0#poll", "wasi:io/poll@0.2.0#[method]pollable.block")')
  .option('--async-exports <exports...>', 'async component exports (examples: "wasi:cli/run@0.2.0#run", "handle")')
