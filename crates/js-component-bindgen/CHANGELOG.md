...
- _(bindgen)_ generate Disposable interface for wasm resources (#901) by @iamrajiv in #901

- _(bindgen)_ support futures and streams (#806) by @vados-cosmonic in #806

- _(bindgen)_ implement waitable set intrinsics (#767) by @vados-cosmonic in #767

- _(bindgen)_ implement yield (#745) by @vados-cosmonic in #745

- _(bindgen)_ implement task.cancel (#743) by @vados-cosmonic in #743

- _(bindgen)_ implement backpressure.set (#742) by @vados-cosmonic in #742

- _(bindgen)_ context.{get|set}, initial task.return impl (#736) by @vados-cosmonic in #736
...
- _(bindgen)_ workaround lint for unused variables in macros by @vados-cosmonic in #1166
...
- _(bindgen)_ use ponyfill for `Promise.withResolvers` by @wooorm-arcjet in #1156

- _(bindgen)_ allow extended const wasm feature during parse by @vados-cosmonic in #1085

- _(bindgen)_ async task return value by @vados-cosmonic in #1084
...
- _(bindgen)_ dispose type generation by @vados-cosmonic in #954

- _(bindgen)_ small fixups to global task id tracking codegen by @vados-cosmonic in #951
...
- _(bindgen)_ intrinsics (#811) by @vados-cosmonic in #811
...
- _(bindgen)_ wit-bindgen -> 0.52.0 by @vados-cosmonic in #1229

- _(bindgen)_ add backpressure dec/inc to early trampolines by @vados-cosmonic

- _(bindgen)_ rustfmt by @vados-cosmonic in #1151
...
- _(bindgen)_ update upstream deps by @vados-cosmonic in #1028

- _(bindgen)_ remove leftover debug logs by @vados-cosmonic in #979

- _(bindgen)_ decouple jco and component bindgen versioning (#635) by @vados-cosmonic in #635
